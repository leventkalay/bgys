...
public class Aksiyon implements Serializable {
    ...
    public Aksiyon aciklama(String aciklama) {
    ...
    public Aksiyon onayDurumu(Onay onayDurumu) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Aksiyon)) {
            return false;
        }
        return id != null && id.equals(((Aksiyon) o).id);
    }

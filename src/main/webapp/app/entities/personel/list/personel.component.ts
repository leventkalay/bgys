...
export class PersonelComponent implements OnInit {
  ...
  trackId(index: number, item: IPersonel): number {
    return item.id!;
  }

  delete(personel: IPersonel): void {
    const modalRef = this.modalService.open(PersonelDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IPersonel[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
